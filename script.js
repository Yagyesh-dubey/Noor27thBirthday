...
"You caught ALL your hair bows! 🎀 <br><br>" +

"Now hand them over like you promised! 😜<br><br>" +

"You earned another special surprise! ✨";
...
nikiBtn.addEventListener("click", () => {
    ...
    partyComment.innerHTML =
    "👧 YAY!! Noor is finally ready!! 🥹💖";

    nikiBtn.innerHTML = "✅ Shotty";
});
...
and, I hope you keep smiling
and live your life the way you want to.

Noor hamesha hasti raha kar... tu hasti bahut pyari lagti hai. 

I may not stay in touch with you but, Just remember there is someone in this universe
 who is praying for in your absence 💖.
